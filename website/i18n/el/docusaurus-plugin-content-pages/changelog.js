        ...
        <div className="m-wrap">
          ...
          <Section id="web" color={C.red} title="Web dashboard (app.marit.es)">
            <Rel version="" date="Ιούνιος 2026" color={C.red}>
              ...
              <li><b>Υγεία μπαταρίας &amp; phantom drain.</b> Τα Στατιστικά δείχνουν τη διατήρηση χωρητικότητας στον χρόνο και πόση μπαταρία χάνετε παρκαρισμένοι &mdash; όπως στην εφαρμογή Core.</li>
