        ...
        <div className="m-wrap">
          ...
          <Section id="web" color={C.red} title="Web dashboard (app.marit.es)">
            <Rel version="" date="Ιούλιος 2026" color={C.red}>
              <li><b>Πίνακας Overview.</b> Νέα σελίδα με συνοπτική εικόνα πρόσφατων διαδρομών, φορτίσεων και κατάστασης μπαταρίας.</li>
              <li><b>Υγεία μπαταρίας: ιδανική έναντι ονομαστικής αυτονομίας.</b> Νέο γράφημα δείχνει την ιδανική αυτονομία (στο 100% SoC) παράλληλα με την ονομαστική, στον χρόνο.</li>
              <li><b>Πίνακας phantom drain.</b> Ημερήσια απώλεια μπαταρίας σε στάση, σε έναν πίνακα.</li>
              <li><b>Βαθμολογία απόδοσης διαδρομής.</b> Κάθε διαδρομή παίρνει βαθμολογία απόδοσης προσαρμοσμένη στη θερμοκρασία (Καλή/Μέτρια/Χαμηλή), με ειλικρινή συμβουλή όταν ένα ταξίδι κατανάλωσε παραπάνω ενέργεια από το συνηθισμένο.</li>
              <li><b>Κόστος φόρτισης ανά μήνα.</b> Τα Στατιστικά δείχνουν τώρα γράφημα μηνιαίου κόστους και kWh φόρτισης.</li>
              <li><b>Φόρτιση σπίτι έναντι δημόσιας.</b> Οι φορτίσεις χαρακτηρίζονται πλέον αυτόματα ως Σπίτι ή Δημόσια.</li>
              <li><b>Ξεχάσατε να φορτίσετε;</b> Προαιρετική ειδοποίηση (Ρυθμίσεις &rarr; Ειδοποιήσεις) όταν το αυτοκίνητο είναι παρκαρισμένο στο σπίτι με χαμηλή μπαταρία και δεν φορτίζει.</li>
              <li><b>Μίνι χάρτης διαδρομής στο PDF.</b> Οι εξαγωγές PDF διαδρομών περιλαμβάνουν πλέον μικρό χάρτη της πορείας.</li>
              <li><b>FSD km &amp; Amps/Watts φόρτισης.</b> Οι διαδρομές δείχνουν χιλιόμετρα με FSD (αυτοκίνητα HW4) και οι φορτίσεις τη μέση ένταση/ισχύ.</li>
            </Rel>
            <Rel version="" date="Ιούλιος 2026" color={C.red}>
