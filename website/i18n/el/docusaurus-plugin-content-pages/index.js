          ...
          <div className="m-page">
            <div className="m-features">
              {[
                ...
                { icon: "🛡", title: "Παρακολούθηση Sentry", body: "Άμεσες ειδοποιήσεις push ή Telegram σε κάθε δραστηριότητα." },
                { icon: "🗺", title: "Ιστορικό διαδρομών", body: "Προηγμένο ιστορικό διαδρομών με κατανάλωση και στατιστικά." },
                { icon: "⚡", title: "Παρακολούθηση φόρτισης", body: "Κατανοήστε κάθε συνεδρία φόρτισης." },
                { icon: "🔔", title: "Προσαρμόσιμοι συναγερμοί", body: "Επιλέξτε πώς ακριβώς αντιδρά το Tesla σας όταν ενεργοποιείται το Sentry." },
                { icon: "📅", title: "Προγραμματισμός", body: "Sentry στο πρόγραμμα που ορίζετε εσείς." },
                { icon: "🔒", title: "Προστασία ιδιωτικότητας", body: "Ποτέ δεν βλέπουμε τον κωδικό σας &mdash; η σύνδεση γίνεται στη σελίδα του Tesla. Καμία πώληση δεδομένων, μόνο το επίσημο Fleet API." },
              ].map(({ icon, title, body }) => (
