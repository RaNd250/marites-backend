defmodule Marites.Settings do
  ...
  alias Marites.{Log, Locations, Vehicles}
  ...
  def subscribe_to_changes(car) do
    Phoenix.PubSub.subscribe(Marites.PubSub, topic(car))
  end
  ...
  defp broadcast(car, settings) do
    Phoenix.PubSub.broadcast(Marites.PubSub, topic(car), settings)
  rescue
    _ -> :ok
  end
end
