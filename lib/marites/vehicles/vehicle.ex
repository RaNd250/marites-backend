defmodule Marites.Vehicles.Vehicle do
  use GenStateMachine
  ...
  def subscribe_to_summary(car_id) do
    Phoenix.PubSub.subscribe(Marites.PubSub, summary_topic(car_id))
  end

  def subscribe_to_fetch(car_id) do
    Phoenix.PubSub.subscribe(Marites.PubSub, fetch_topic(car_id))
  end
  ...
  def handle_event(:internal, :broadcast_summary, state, %Data{last_response: vehicle} = data) do
    ...
    :ok =
      call(data.deps.pubsub, :broadcast, [Marites.PubSub, summary_topic(data.car.id), payload])
