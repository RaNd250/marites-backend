defmodule Marites.Mqtt.PubSub.VehicleSubscriber do
  use GenServer

  require Logger
  import Core.Dependency, only: [call: 3]

  alias Marites.Mqtt.Publisher
  ...
  # from installations before PR #4817: https://github.com/Marites-org/Marites/pull/4817
  defp clear_retained(car_id, namespace, publisher) do
    Enum.each(@do_not_retain, fn key ->
      topic =
        ["Marites", namespace, "cars", car_id, key]
