defmodule MaritesWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MaritesWeb

      import Plug.Conn
      use Gettext, backend: MaritesWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MaritesWeb.LayoutView, :live}
  ...
  defp view_helpers do
    quote do
      ...
      import MaritesWeb.ErrorHelpers
      use Gettext, backend: MaritesWeb.Gettext
      alias MaritesWeb.Router.Helpers, as: Routes
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: MaritesWeb.Router,
        statics: MaritesWeb.static_paths()
    end
  end
