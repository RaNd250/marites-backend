defmodule Marites.Characterization do
  @moduledoc """
  ...
  geofence detection runs against the real `Marites.Locations`.
  ...
  `deps_vehicles` is `Marites.Characterization.Vehicles`: production
  ...
  The vehicle runs on the replay's clock (`Marites.Characterization.Clock`
  ...
  alias Marites.Characterization.Clock
  ...
  defp replay(input, run_id) do
    ...
    {:ok, subscriber} =
      start_supervised(
        {VehicleSubscriber,
         car_id: car.id, deps_publisher: {MqttPublisherMock, publisher}, discovery: false, namespace: nil}
      )
  ...
  @settings_fields Marites.Settings.CarSettings.__schema__(:fields) -- [:id, :enabled]
  ...
  @position_fields Marites.Log.Position.__schema__(:fields) --
